...
//Last modified: Tue, Sep 15, 2026 10:25:33 AM
//Codeset: UTF-8
...
fileInfo "UUID" "F0C61AEE-9C49-206A-0ACB-33A5AECE4D1A";
createNode transform -s -n "persp";
	rename -uid "81757271-DA4F-6B02-759B-A7A6F6F3C64A";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.4773576242413995 6.0782109908058501 1.9034617661511186 ;
	setAttr ".r" -type "double3" -35.264389682755038 -134.59999999999548 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 2.9051459878964629;
